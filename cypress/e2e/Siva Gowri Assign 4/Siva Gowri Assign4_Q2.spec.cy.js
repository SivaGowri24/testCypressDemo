describe('Registration Form Validation', () => {
  ...
  it.only('Registration Successful', () => {
    cy.get('input[name="username"]').type('SivaGowrii12345');
    cy.get('#password').type('SGowrii1234567!!');
    cy.get('#confirmPassword').type('SGowrii1234567!!');
   ...
   it('Password Mismatch', () => {
    cy.get('input[name="username"]').type('SivaGowrii12345');
    cy.get('#password').type('PasworrdMismatchh!!');
    cy.get('#confirmPassword').type('SGowrii1234567!!');
    cy.get('button[type="submit"]').should('be.visible').and('contain.text', 'Register').click();
