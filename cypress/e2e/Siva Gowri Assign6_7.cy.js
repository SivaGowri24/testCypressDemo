import Formdata from "../fixtures/user.json"
// 1. Using Fixtures for Test Data
// Assignment A
describe('Assignment_6', () => {
    it('login', () => {
...
//Assignment A
 it('Select QA checkbox, India from Country dropdown, and Blue radio button', () => {
...
//Assignment B 
it('Select India from Country dropdown', () => {
 ...
 //Assignment C
  it('Hover over the tooltip trigger on tooltips', () => {
...
// 4. Looping through rows with .each()

// Assignment A On /dynamic-table, use .each() to log each browser name and its CPU usage.
// Assignment B Count how many browsers have CPU usage over 20%.

describe('Looping through rows with .each()', () => {
  it('Count no. of browsers have CPU usage over 20%', () => {
...
describe('Dynamic Table - locate the Chrome', () => {
  it('Compare its CPU value in the table with the yellow label (#chrome-cpu)', () => {
    cy.visit('https://practice.expandtesting.com/dynamic-table');
